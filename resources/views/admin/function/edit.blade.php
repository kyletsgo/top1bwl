...
<div class="row">
	<div class="col-lg-12">
		<form id="EditForm" class="form-horizontal" method="post" action="{{ asset('/backend/menu/' . $menu->id . '/function/' . $function->id) }}">
			{{ csrf_field() }}
			<input type="hidden" name="menu_id" value="{{ $menu->id }}">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h4 class="panel-title">編輯功能 - 選單:{{ $menu->name }}</h4>
				</div>
						...
						<table class="table" cellspacing="0" id="DetailsView1" style="border-collapse:collapse;">
							<tbody>
								<tr>
									...
									<td>
										<div class="col-lg-2 nopadding">
											<input name="name" type="text" value="{{ $function->name }}" maxlength="100" id="name" class="form-control">
								...
								<tr>
									...
									<td>
										<div class="col-lg-3 nopadding">
											<input name="link" type="text" value="{{ $function->link }}" maxlength="200" id="link" class="form-control">
								...
								<tr>
									...
									<td>
										<div class="col-lg-3 nopadding">
											<input name="description" type="text" value="{{ $function->description }}" maxlength="200" id="description" class="form-control">
								...
								<tr>
									...
									<td>
										<div class="col-lg-1 nopadding">
											<input name="order" type="number" value="{{ $function->order }}" id="order" class="form-control">
								...
								<tr>
									...
									<td>
										<div class="col-lg-1 nopadding checkbox checkbox-primary">
											<input name="valid" type="checkbox" id="valid" @if ($function->valid === 1) checked @endif>
											<label></label>
								...
								<tr>
									<td class="col-lg-1">建立時間</td>
									<td>{{ $function->created_at }}</td>
								</tr>

								<!-- Edit Mode -->
								<tr>
									<td class="col-lg-1">最後修改</td>
...
<script>
	...
	$(document).ready(function () {
		...
		$("#btnBackTo2_foot").click(function () {
			location.href = '{{ asset('backend/menu/' . $menu->id . '/function') }}';
		});
