...
<div class="row">
	<div class="col-lg-12">
		<form id="EditForm" class="form-horizontal" method="post" action="{{ asset('/backend/menu/' . $menu->id) }}">
			{{ csrf_field() }}
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h4 class="panel-title">編輯選單</h4>
				</div>
						...
						<table class="table" cellspacing="0" id="DetailsView1" style="border-collapse:collapse;">
							<tbody>
								<tr>
									...
									<td>
										<div class="col-lg-2 nopadding">
											<input name="icon" type="text" value="{{ $menu->icon }}" maxlength="20" id="icon" class="form-control">
								...
								<tr>
									...
									<td>
										<div class="col-lg-3 nopadding">
											<input name="name" type="text" value="{{ $menu->name }}" maxlength="20" id="name" class="form-control">
								...
								<tr>
									...
									<td>
										<div class="col-lg-2 nopadding">
											<input name="order" type="number" value="{{ $menu->order }}" id="order" class="form-control">
								...
								<tr>
									...
									<td>
										<div class="col-lg-3 nopadding checkbox checkbox-primary">
											<input name="valid" type="checkbox" id="valid" @if ($menu->valid === 1) checked @endif>
											<label></label>
...
<script>
	...
	$(document).ready(function () {
		...
		$("#btnBackTo2_foot").click(function () {
			location.href = '{{ url('backend/menu') }}';
		});
