...
<div class="row">
	<div class="col-lg-12">
		<form id="EditForm" class="form-horizontal" method="post" action="{{ asset('/backend/group/store') }}">
			{{ csrf_field() }}
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h4 class="panel-title">新增群組</h4>
				</div>
								...
								<tr>
									...
									<td>
										<div class="col-lg-3 nopadding">
											<input name="name" type="text" maxlength="20" id="name" class="form-control">
								...
								<tr>
									...
									<td>
										<div class="col-lg-3 nopadding mr-10">
											...
											<select class="form-control" id="users" multiple></select>
										</div>
										<div class="col-lg-3 nopadding">
								...
								<tr>
									...
									<td>
										<div class="col-lg-3 nopadding mr-10">
											...
											<select class="form-control" id="functions" multiple></select>
										</div>
										<div class="col-lg-3 nopadding">
